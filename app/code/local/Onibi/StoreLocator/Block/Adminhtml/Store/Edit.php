...
class Onibi_StoreLocator_Block_Adminhtml_Store_Edit extends Mage_Adminhtml_Block_Widget_Form_Container

{
...

    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('onibi_storelocator')->__('Save Store'));

        $this->_updateButton('delete', 'label', Mage::helper('onibi_storelocator')->__('Delete Store'));



        $this->_addButton('saveandcontinue', array(

            'label'     => Mage::helper('onibi_storelocator')->__('Save and Continue Edit'),
...

    {
        ...
        if (Mage::registry('onibi_storelocator')->getId()) {
